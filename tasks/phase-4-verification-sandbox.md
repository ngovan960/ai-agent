...
### Tasks
- [ ] **4.1.1** — Implement verification pipeline service
...
### Tasks
- [ ] **4.2.1** — Implement OpenCode verification adapter
...
- [ ] **4.2.2** — Implement bash tool delegation cho lint
  - Command: `ruff check .` hoặc `eslint .`
  - Capture: stdout, stderr, exit_code
- [ ] **4.2.3** — Implement bash tool delegation cho tests
  - Command: `pytest tests/` hoặc `npm test`
  - Capture: test results, coverage
- [ ] **4.2.4** — Implement bash tool delegation cho build
  - Command: `npm run build` hoặc `python -m build`
  - Capture: build output, errors
- [ ] **4.2.5** — Implement bash tool delegation cho security scan
  - Command: `bandit -r .` hoặc `npm audit`
  - Capture: vulnerabilities
- [ ] **4.2.6** — Implement timeout handling cho dev mode
  - Max execution time: 10 minutes
  - Auto-kill nếu vượt timeout
- [ ] **4.2.7** — Implement result parsing cho dev mode
  - Parse exit code: 0 → VERIFIED, != 0 → FAILED
  - Extract error messages từ stdout/stderr
- [ ] **4.2.8** — Unit test cho OpenCode verification
...
### Tasks
- [ ] **4.3.1** — Implement Docker sandbox manager
...
- [ ] **4.3.2** — Implement mount repo vào container
...
- [ ] **4.3.3** — Implement run verification trong container
  - Execute verification pipeline
  - Capture stdout, stderr, exit code
  - Function: `run_verification(container_id) -> verification_result`
- [ ] **4.3.4** — Implement capture logs từ container
  - Collect container logs
  - Store logs với task_id reference
  - Function: `capture_logs(container_id) -> logs`
- [ ] **4.3.5** — Implement destroy container sau khi hoàn thành
  - Clean up container sau khi verification xong
  - Function: `destroy_container(container_id) -> status`
- [ ] **4.3.6** — Implement container timeout
  - Max execution time: 10 minutes
  - Auto-kill nếu vượt timeout
- [ ] **4.3.7** — Implement resource limits (CPU, RAM) cho container
  - CPU: max 2 cores
  - RAM: max 4GB
- [ ] **4.3.8** — Implement sandbox security
  - No network access (trừ khi cần)
  - No host filesystem access
  - No privileged mode
- [ ] **4.3.9** — Unit test cho Docker sandbox
...
### Tasks
- [ ] **4.6.1** — Implement mode selection service
...
- [ ] Verification pipeline hoạt động (5 steps)
- [ ] Dev mode (OpenCode) hoạt động
- [ ] Prod mode (Docker) hoạt động
- [ ] Auto mode selection theo risk level
- [ ] Có rollback khi fail
- [ ] Integration tests pass
